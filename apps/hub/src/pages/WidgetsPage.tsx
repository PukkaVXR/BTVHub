...
import { Button, ButtonAnchor, Callout, Card, CardHeader, PageHeader, SplitWorkspace, StatusPill } from "../ui";
...
export default function WidgetsPage() {
  ...
  const [goals, setGoals] = useState<Array<{ id: string; label: string; current_count: number; target_count: number }>>(
    [],
  );
  ...
  return (
    <>
      ...
      <SplitWorkspace
        className="widgets-workspace"
        sidebarClassName="widgets-sidebar"
        detailClassName="widgets-detail"
        sidebarLabel="Widget sections"
        sidebar={
          <>
            <button
              type="button"
              className={selectedPanel === "theme" ? "active" : ""}
            ...
            <button
              type="button"
              className={selectedPanel === "overrides" ? "active" : ""}
              onClick={() => setSelectedPanel("overrides")}
            >
              <span>Overrides</span>
            ...
            <button
              type="button"
              className={selectedPanel === "goals" ? "active" : ""}
              onClick={() => setSelectedPanel("goals")}
            >
        ...
        detail={
          <>
                  ...
                  <>
                    ...
                    <div className="grid widget-control-grid">
                      ...
                      <div className="form-row">
                        ...
                        <ColorAlphaControl
                          label="Accent"
                          value={overlayTheme.accentColor}
                          fallback="#9147ff"
                      ...
                      <div className="form-row">
                        ...
                        <ColorAlphaControl
                          label="Muted text"
                          value={overlayTheme.mutedColor}
                          fallback="#ffffff"
                          onChange={(mutedColor) => updateTheme({ mutedColor })}
                        />
                      </div>
                      <div className="form-row">
                        ...
                        <ColorAlphaControl
                          ...
                          value={overlayTheme.panelBackground}
                          fallback="#000000"
                          onChange={(panelBackground) => updateTheme({ panelBackground })}
                        />
                      </div>
                      <div className="form-row">
                        ...
                        <ColorAlphaControl
                          ...
                          value={overlayTheme.itemBackground}
                          fallback="#ffffff"
                          onChange={(itemBackground) => updateTheme({ itemBackground })}
                        />
                      </div>
                      <div className="form-row">
                        ...
                        <ColorAlphaControl
                          label="Border colour"
                          value={overlayTheme.borderColor}
                          fallback="#ffffff"
                          onChange={(borderColor) => updateTheme({ borderColor })}
                        />
                      </div>
                    </div>
                    ...
                    <div className="grid widget-control-grid">
                      <div className="form-row">
                        ...
                        <input
                          ...
                          min={0}
                          max={48}
                          value={overlayTheme.borderRadius}
                      ...
                      <div className="form-row">
                        ...
                        <input
                          ...
                          min={0}
                          max={90}
                          value={overlayTheme.shadow}
                          onChange={(e) => updateTheme({ shadow: Number(e.target.value) })}
                        />
                      </div>
                      <div className="form-row">
                        ...
                        <input
                          ...
                          min={0}
                          max={90}
                          value={overlayTheme.glow}
                          onChange={(e) => updateTheme({ glow: Number(e.target.value) })}
                        />
                      </div>
                      <div className="form-row">
                        ...
                        <input
                          ...
                          max={1}
                          step={0.05}
                          value={overlayTheme.backgroundOpacity}
                      ...
                      <div className="form-row">
                        ...
                        <input
                          ...
                          min={0}
                          max={40}
                          value={overlayTheme.backgroundBlur}
                      ...
                      <label className="widget-check-field">
                        <input
                          ...
                          onChange={(e) => updateTheme({ pulse: e.target.checked })}
                        />{" "}
                    ...
                    <div className="form-row">
                      ...
                      <MediaPicker
                        value={overlayTheme.backgroundImage.replace(/^\/assets\//, "")}
                        onChange={(path) => updateTheme({ backgroundImage: path ? `/assets/${path}` : "" })}
                      />
                    ...
                    <div className="actions">
                      <button
                        type="button"
                        className="ui-button ui-button--secondary ui-button--sm"
                        onClick={() => setOverlayTheme(DEFAULT_OVERLAY_THEME)}
                      >
                        Reset theme
                      </button>
                    </div>
                          ...
                          >
                            ...
                            {!canCustomizeText && (
                              <p className="theme-card-note">
                                Chat names use Twitch colours and badges, so text colour overrides are disabled for
                                chat.
                              </p>
                            )}
                            <div className="overlay-widget-theme-fields">
                              ...
                              <div className="form-row">
                                ...
                                <input
                                  ...
                                  onChange={(e) =>
                                    updateWidgetTheme(target.id, { borderRadius: Number(e.target.value) })
                                  }
                                />
                              </div>
                              <div className="form-row">
                                <label>
                                  Background opacity (
                                  {Math.round((item.backgroundOpacity ?? overlayTheme.backgroundOpacity) * 100)}%)
                                </label>
                                <input
                                  type="range"
                                  min={0}
                                  ...
                                  onChange={(e) =>
                                    updateWidgetTheme(target.id, { backgroundOpacity: Number(e.target.value) })
                                  }
                                />
                              </div>
                              <div className="form-row">
                                ...
                                <input
                                  ...
                                  onChange={(e) =>
                                    updateWidgetTheme(target.id, { backgroundBlur: Number(e.target.value) })
                                  }
                                />
                              </div>
                            </div>
                            ...
                            <div className="form-row overlay-widget-theme-background">
                              ...
                              <MediaPicker
                                ...
                                onChange={(path) =>
                                  updateWidgetTheme(target.id, {
                                    backgroundImage: path ? `/assets/${path}` : undefined,
                                  })
                                }
                              />
                              {item.backgroundImage && (
                                <button
                                  type="button"
                                  className="ui-button ui-button--secondary ui-button--sm"
                                  onClick={() => updateWidgetTheme(target.id, { backgroundImage: undefined })}
                                >
                                  Remove background image
                                </button>
                              )}
            ...
            {widgets
              .filter((w) => selectedPanel === `widget:${w.id}`)
              .map((w) => (
                <Card
                  key={w.id}
                  className="widget-config-card"
                  hideableId={`widget-${w.id}`}
                  hideableTitle={formatWidgetLabel(w)}
                >
                  <CardHeader
                    ...
                    action={
                      <div className="widget-config-actions">
                        ...
                        />
                        <ButtonAnchor
                          href={`${overlayOrigin}${widgetPreviewRoute(w)}`}
                          target="_blank"
                          rel="noreferrer"
                          size="sm"
                        >
                  ...
                  <label>
                    <input
                      ...
                      checked={w.enabled}
                      onChange={(e) =>
                        setWidgets((ws) => ws.map((x) => (x.id === w.id ? { ...x, enabled: e.target.checked } : x)))
                      }
                    />{" "}
                    Enabled
                  </label>
                  {w.type === "chat" && (
                    <>
                      <Callout title="BTTV refresh note">
                        BTTV emotes are checked when the OBS Chat browser source loads. If you add or remove BTTV
                        emotes, refresh the Chat source in OBS to update the emote list.
                      </Callout>
                      <div className="form-row">
                      ...
                      <div className="form-row">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setWidgets((ws) =>
                              ws.map((x) =>
                                x.id === w.id ? { ...x, config: { ...x.config, fadeMs: Number(e.target.value) } } : x,
                              ),
                            )
                          }
                        />
                      ...
                      <label className="toggle-row">
                        <input
                          ...
                          onChange={(e) =>
                            setWidgets((ws) =>
                              ws.map((x) =>
                                x.id === w.id ? { ...x, config: { ...x.config, showStats: e.target.checked } } : x,
                              ),
                            )
                          }
                        />{" "}
                    ...
                    <>
                      ...
                      <div className="actions widget-actions-spaced">
                        <label>
                          <input
                            type="checkbox"
                            checked={w.config.compact === true}
                            onChange={(e) =>
                              setWidgets((ws) =>
                                ws.map((x) =>
                                  x.id === w.id ? { ...x, config: { ...x.config, compact: e.target.checked } } : x,
                                ),
                              )
                            }
                          />{" "}
                        ...
                        <label>
                          <input
                            type="checkbox"
                            checked={w.config.showUser !== false}
                            onChange={(e) =>
                              setWidgets((ws) =>
                                ws.map((x) =>
                                  x.id === w.id ? { ...x, config: { ...x.config, showUser: e.target.checked } } : x,
                                ),
                              )
                            }
                          />{" "}
                        ...
                        <label>
                          <input
                            type="checkbox"
                            checked={w.config.showAmount === true}
                            onChange={(e) =>
                              setWidgets((ws) =>
                                ws.map((x) =>
                                  x.id === w.id ? { ...x, config: { ...x.config, showAmount: e.target.checked } } : x,
                                ),
                              )
                            }
                          />{" "}
                                ...
                                onChange={(e) =>
                                  setWidgets((ws) =>
                                    ws.map((x) => {
                                      ...
                                      const current = Array.isArray(x.config.eventTypes)
                                        ? (x.config.eventTypes as string[])
                                        : [];
                      ...
                      <label>
                        <input
                          ...
                          onChange={(e) =>
                            setWidgets((ws) =>
                              ws.map((x) =>
                                x.id === w.id ? { ...x, config: { ...x.config, showMessage: e.target.checked } } : x,
                              ),
                            )
                          }
                        />{" "}
                  ...
                  <div key={g.id} className="widget-goal-row">
                    <div>
                      ...
                      <input
                        value={g.label}
                        onChange={(e) =>
                          setGoals((gs) => gs.map((x) => (x.id === g.id ? { ...x, label: e.target.value } : x)))
                        }
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setGoals((gs) =>
                            gs.map((x) => (x.id === g.id ? { ...x, current_count: Number(e.target.value) } : x)),
                          )
                        }
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setGoals((gs) =>
                            gs.map((x) => (x.id === g.id ? { ...x, target_count: Number(e.target.value) } : x)),
                          )
                        }
                      />
                    </div>
...
function themePreviewStyle(theme: OverlayThemeConfig): CSSProperties {
  return {
    ...
    backgroundImage: theme.backgroundImage
      ? `linear-gradient(${theme.panelBackground}, ${theme.panelBackground}), url("${theme.backgroundImage}")`
      : "none",
